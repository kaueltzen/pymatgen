...
class LobsterNeighborsVisualizer:
    ...
    def from_lobster_calc(
        ...
        **kwargs,
        ...
        """
        lobster_neighbors = LobsterNeighbors(*args, **kwargs)
        return cls(lobster_neighbors=lobster_neighbors, bond_tol=bond_tol)
    ...
    def write_vesta(self, file_name: str = "output.vesta") -> None:
        """
